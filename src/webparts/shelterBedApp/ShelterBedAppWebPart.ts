...
import * as strings from "ShelterBedAppWebPartStrings";
import ShelterBedApp from "./components/ShelterBedApp";
import { IShelterBedAppProps } from "./components/IShelterBedAppProps";
...
export default class ShelterBedAppWebPart extends BaseClientSideWebPart<IShelterBedAppWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IShelterBedAppProps> =
      React.createElement(ShelterBedApp, {
